(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".notMin").on("click", function () {
            ...
            if (firstPrice < minPrice) {
                ...
                $(".popAlert .popAlertText").html(`🚀 ¡Falta poco! <br>
    ...
    const imgWordsArray = [
        ...
        [
            ...
            `${ajax_variables.pluginUrl}img/letters/Claro/heart.png`,
            " ",
            `${ajax_variables.pluginUrl}img/letters/Claro/b.png`,
            `${ajax_variables.pluginUrl}img/letters/Claro/r.png`,
            `${ajax_variables.pluginUrl}img/letters/Claro/o.png`,
            `${ajax_variables.pluginUrl}img/letters/Claro/w.png`,
            `${ajax_variables.pluginUrl}img/letters/Claro/n.png`,
            `${ajax_variables.pluginUrl}img/letters/Claro/i.png`,
